...
def upgrade() -> None:
    ...
    op.execute("DO $$ BEGIN CREATE TYPE consenttype AS ENUM ('personal_data', 'cookies', 'marketing'); EXCEPTION WHEN duplicate_object THEN null; END $$")
    ...
    op.create_table('privacy_consents',
        ...
        sa.Column('consent_type', sa.Enum('personal_data', 'cookies', 'marketing', name='consenttype'), nullable=False),
    ...
    op.create_index('idx_privacy_consent_session_id', 'privacy_consents', ['session_id'])

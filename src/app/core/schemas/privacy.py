...
class PrivacyConsentRequest(BaseModel):
    ...
    personal_data: Annotated[bool, Field(
        ..., 
        description="Согласие на обработку персональных данных (обязательно)"
    )]
    cookies: Annotated[bool, Field(
        default=False,
        description="Согласие на использование файлов cookie"
    )]
    marketing: Annotated[bool, Field(
        default=False,
        description="Согласие на маркетинговые коммуникации"
    )]
    timestamp: Annotated[Optional[str], Field(
        None,
        description="Временная метка согласия в ISO формате"
    )]
...
class ConsentStatusResponse(BaseModel):
    ...
    personal_data: Annotated[bool, Field(..., description="Наличие согласия на обработку персональных данных")]
    cookies: Annotated[bool, Field(..., description="Наличие согласия на использование cookies")]
    ...
    last_updated: Annotated[Optional[datetime], Field(
        None, 
        description="Дата последнего обновления согласия"
    )]
...
class PrivacyConsentInfo(BaseModel):
    ...
    policy_version: Annotated[str, Field(..., description="Версия политики конфиденциальности")]
